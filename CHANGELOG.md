...
- Added `CreateInstance` method to audio events to create instances without playing.
- Added `PlayAndReturnInstance` method to audio events to return created instances.
